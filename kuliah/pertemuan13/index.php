  ...
  <div class="wrapper d-flex align-items-stretch">
    ...
    <div id="content" class="p-4 p-md-5">
      ...
      <form action="" method="POST">
        <input type="text" name="keyword" size="30" placeholder="Masukkan Keyword Pencarian" autocomplete="off" autofocus class="keyword" <button type="submit" name="cari" class="tombol-cari"></button>
      </form>
      <br>
